...
1. Extracted passenger titles from names. 
2. Created derived fields (Age group, Family group, deck)
3. Used pivot tables to summarize survival trends.
4. Compared class, gender, and family group survival.
5. Analyzed average fare groups.
